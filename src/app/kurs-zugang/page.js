...
export default function KursZugangAssessment() {
  ...
  const [customerPlan, setCustomerPlan] = useState('kurs')
  ...
  // Zugangspruefung per individuellem Code
  useEffect(() => {
      ...
      <div className="min-h-screen bg-gray-50 py-20">
        <div className="max-w-lg mx-auto px-4">
          <div className="card text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-4">Online-Kurs Zugang</h1>
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-center text-lg tracking-wider"
                  autoFocus
                />
              </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              ...
              <a href="/#preise" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                Zu den Preisen &rarr;
              </a>
            </div>
          </div>
        ...
        <div className="max-w-2xl mx-auto px-4">
          <div className="card">
            <div className="text-center mb-8">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ background: 'linear-gradient(135deg, #1e3a8a, #2563eb)' }}>
                <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h1 className="text-2xl font-bold text-gray-900 mb-2">Online-Kurs: KI-Einf&uuml;hrung f&uuml;r KMU</h1>
              <p className="text-gray-600">
                Absolvieren Sie zuerst das KI-Readiness Assessment. Anschlie&szlig;end erhalten Sie Zugang zu allen 7 Kursmodulen.
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
              ...
              {[
                ...
                <div key={i} className="flex">
                  <div className="flex flex-col items-center mr-4">
                    ...
                    {i < 2 && <div className="w-0.5 h-full bg-blue-200 mt-2" />}
                  </div>
                  <div className="pb-6">
                    <h3 className="font-bold text-gray-900">{phase.phase}</h3>
                    <p className="text-sm text-blue-600 mb-2">{phase.zeit}</p>
          ...
          <div className="card mb-8 fade-in-up">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-900">Ihre Kursmodule</h2>
            </div>
            <div className="space-y-3">
              {kursModule.map((modul) => (
                <div key={modul.nr} className="flex items-center p-4 bg-gray-50 rounded-xl border border-gray-200 hover:border-blue-300 transition-colors">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center font-bold text-white flex-shrink-0 mr-4" style={{ background: 'linear-gradient(135deg, #1e3a8a, #2563eb)' }}>
                    {modul.nr}
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold text-gray-900">Modul {modul.nr}: {modul.title}</h3>
                  </div>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-100">
              <div className="flex items-start">
                ...
                <p className="text-sm text-blue-700">
                  Ihre Kursmodule werden Ihnen in K&uuml;rze per E-Mail zugesendet.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="card text-center mb-8 bg-blue-50 border-blue-200">
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2.5">
            <div className="bg-blue-600 h-2.5 rounded-full progress-bar" style={{ width: `${progress}%` }} />
          </div>
        </div>
        ...
        <div className="card fade-in-up" key={currentQuestion}>
          <div className="flex items-center gap-2 mb-4">
            <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-md text-xs font-semibold">Kurs</span>
            ...
            {question.options.map((option, i) => (
              ...
              >
                <div className="flex items-center">
                  <div className="w-8 h-8 rounded-full bg-gray-100 group-hover:bg-blue-100 flex items-center justify-center mr-4 flex-shrink-0 transition-colors">

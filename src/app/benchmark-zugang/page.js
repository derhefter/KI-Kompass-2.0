...
export default function BenchmarkAssessment() {
  ...
  const [customerPlan, setCustomerPlan] = useState('benchmark')
    ...
    try {
      ...
      if (data.valid) {
        if (data.plan !== 'benchmark') {
          ...
          setCustomerPlan(data.plan || 'benchmark')
        }
      ...
      <div className="min-h-screen bg-gray-50 py-20">
        <div className="max-w-lg mx-auto px-4">
          <div className="card text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-4">Branchen-Benchmark Zugang</h1>
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none text-center text-lg tracking-wider"
                  autoFocus
                />
              </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              ...
              <a href="/#preise" className="text-sm text-amber-600 hover:text-amber-700 font-medium">
                Zu den Preisen &rarr;
              </a>
            </div>
          </div>
        ...
        <div className="max-w-2xl mx-auto px-4">
          <div className="card">
            <div className="text-center mb-8">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ background: 'linear-gradient(135deg, #d97706, #f59e0b)' }}>
                <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <h1 className="text-2xl font-bold text-gray-900 mb-2">Branchen-Benchmark Report</h1>
              <p className="text-gray-600">
                Absolvieren Sie das KI-Readiness Assessment. Ihre Ergebnisse werden mit anonymisierten Branchendaten verglichen.
              </p>
            </div>
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="card text-center mb-8 fade-in-up">
            <div className="inline-flex items-center px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-sm font-semibold mb-4">
              Branchen-Benchmark
            </div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              Benchmark Report f&uuml;r {companyName}
            </h1>
          ...
          <div className="card mb-8 fade-in-up">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-900">Branchenvergleich</h2>
            </div>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm font-semibold text-amber-800 mb-1">Ihr individueller Branchenvergleich wird derzeit erstellt.</p>
                  <p className="text-sm text-amber-700">
                    Basierend auf anonymisierten Daten aus Ihrer Branche erhalten Sie in K&uuml;rze einen detaillierten Vergleichsreport per E-Mail.
                  </p>
                </div>
              </div>
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b-2 border-gray-200">
                    <th className="text-left py-3 px-4 font-semibold text-gray-700">Bereich</th>
                    <th className="text-center py-3 px-4 font-semibold text-gray-700">Ihr Score</th>
                    <th className="text-center py-3 px-4 font-semibold text-gray-700">Branchendurchschnitt</th>
                    <th className="text-center py-3 px-4 font-semibold text-gray-700">Differenz</th>
                  </tr>
                </thead>
                <tbody>
                  {result.categoryScores.map((cat) => (
                    <tr key={cat.key} className="border-b border-gray-100">
                      <td className="py-3 px-4 font-medium text-gray-800">{cat.label}</td>
                      <td className="py-3 px-4 text-center">
                        <span className="font-bold" style={{ color: cat.percentage > 60 ? '#22c55e' : cat.percentage > 35 ? '#f59e0b' : '#ef4444' }}>
                          {cat.percentage}%
                        </span>
                      </td>
                      <td className="py-3 px-4 text-center text-gray-400 font-medium">&ndash;</td>
                      <td className="py-3 px-4 text-center text-gray-400 font-medium">&ndash;</td>
                    </tr>
                  ))}
                  <tr className="border-t-2 border-gray-200 bg-gray-50">
                    <td className="py-3 px-4 font-bold text-gray-900">Gesamt</td>
                    <td className="py-3 px-4 text-center">
                      <span className="font-bold" style={{ color: result.levelColor }}>{result.percentage}%</span>
                    </td>
                    <td className="py-3 px-4 text-center text-gray-400 font-medium">&ndash;</td>
                    <td className="py-3 px-4 text-center text-gray-400 font-medium">&ndash;</td>
                  </tr>
              ...
              {[
                ...
                <div key={i} className="flex">
                  <div className="flex flex-col items-center mr-4">
                    <div className="w-10 h-10 text-white rounded-full flex items-center justify-center font-bold" style={{ background: 'linear-gradient(135deg, #d97706, #f59e0b)' }}>
                      {i + 1}
                    </div>
                    {i < 2 && <div className="w-0.5 h-full bg-amber-200 mt-2" />}
                  </div>
                  <div className="pb-6">
                    <h3 className="font-bold text-gray-900">{phase.phase}</h3>
                    <p className="text-sm text-amber-600 mb-2">{phase.zeit}</p>
          ...
          {/* Benchmark Report Info */}
          <div className="card mb-8 fade-in-up bg-amber-50 border-amber-200">
            <div className="flex items-start">
              <svg className="w-6 h-6 text-amber-600 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
              </svg>
              <div>
                <h3 className="font-bold text-gray-900 mb-1">Ihr detaillierter Benchmark-Report</h3>
                <p className="text-sm text-gray-700">
                  Ihr detaillierter Benchmark-Report mit Branchenvergleichsdaten wird Ihnen in K&uuml;rze per E-Mail zugesendet.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="card text-center mb-8 bg-amber-50 border-amber-200">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Ihren Report speichern</h2>
            <p className="text-gray-600 mb-6">
              Ein ausf&uuml;hrlicher PDF-Report mit Branchenvergleich wurde automatisch an <strong>{contactEmail}</strong> gesendet.
          ...
          <div className="card border-2 border-accent-400 bg-gradient-to-br from-accent-50 to-white text-center">
            ...
            <p className="text-gray-600 mb-4 max-w-xl mx-auto">
              Mit unserem <strong>Strategie-Paket</strong> erhalten Sie zus&auml;tzlich zu Ihrem Benchmark Report:
            </p>
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2.5">
            <div className="h-2.5 rounded-full progress-bar" style={{ width: `${progress}%`, background: 'linear-gradient(135deg, #d97706, #f59e0b)' }} />
          </div>
        </div>
        ...
        <div className="card fade-in-up" key={currentQuestion}>
          <div className="flex items-center gap-2 mb-4">
            <span className="px-2 py-1 bg-amber-100 text-amber-700 rounded-md text-xs font-semibold">Benchmark</span>
          ...
          <div className="space-y-3">
            {question.options.map((option, i) => (
              <button
                ...
                className="w-full text-left p-4 rounded-xl border-2 border-gray-200 hover:border-amber-400 hover:bg-amber-50 transition-all duration-200 group"
              >
                <div className="flex items-center">
                  <div className="w-8 h-8 rounded-full bg-gray-100 group-hover:bg-amber-100 flex items-center justify-center mr-4 flex-shrink-0 transition-colors">
                    <span className="text-sm font-semibold text-gray-500 group-hover:text-amber-600 transition-colors">

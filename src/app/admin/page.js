  ...
  const sections = [
    {
      ...
      items: [
        ...
        'MOLLIE_API_KEY=live_... (von Mollie Dashboard > Einstellungen > API-Keys)',
    ...
    {
      title: '3. SETUP: Mollie einrichten',
      file: 'Mollie Dashboard (my.mollie.com)',
      items: [
        'Mollie-Konto erstellen unter mollie.com',
        'API-Key kopieren: Dashboard > Einstellungen > API-Keys -> MOLLIE_API_KEY',
        'Webhook wird automatisch pro Zahlung gesetzt (auf /api/mollie-webhook)',
        'Unterstuetzte Zahlungsarten: Kreditkarte, SEPA, Klarna, iDEAL, PayPal, u.v.m.',
        'Zahlungsarten im Mollie Dashboard aktivieren/deaktivieren',
        'Produkte werden im Code definiert: Premium 197, Strategie 497, Zertifikat 97, Kurs 297',
        'Preise aendern in: src/app/api/create-checkout/route.js (PRODUCTS Objekt)',
      ],
      hint: 'Im Testmodus erst mit test_ API-Key testen, dann auf live_ umstellen! Webhook-URL muss oeffentlich erreichbar sein (funktioniert auf Vercel automatisch).',
    },
    {
    ...
    {
      title: 'Mollie-Zahlungen (automatisch)',
      file: 'src/app/api/create-checkout + mollie-webhook',
      items: [
        '4 Produkte: premium (197), strategie (497), zertifikat (97), kurs (297)',
        'Kunde wird zur Mollie-Zahlungsseite weitergeleitet (Kreditkarte, SEPA, Klarna, iDEAL, ...)',
        'Nach Zahlung: Mollie sendet Webhook -> Zugangscode wird automatisch generiert',
        'Code wird per E-Mail an Kunde + Benachrichtigung an dich gesendet',
        'Zahlungs-Erfolgsseite: /zahlung-erfolgreich',
        'Alternativ: Kunden koennen auch per Rechnung zahlen (separater Flow)',
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        'Automatisch: Mollie erzeugt Codes nach Zahlung -> Google Sheets',
    ...
    },
    {
      ...
      items: [
        ...
        'Datenschutz um Mollie-Hinweis ergaenzen (bereits eingefuegt)',
        'Cookie-Hinweis pruefen',
      ],
      hint: 'Vor Go-Live von einem Anwalt pruefen lassen!',
    },
  ]
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-gray-600">
                {[
                  ...
                  ['Mollie Client', 'src/lib/mollie.js'],
                  ['Mollie Checkout', 'src/app/api/create-checkout/route.js'],
                  ['Mollie Webhook', 'src/app/api/mollie-webhook/route.js'],
